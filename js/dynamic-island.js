        ...
        setTimeout(() => {
            ...
            this.expanded.innerHTML = `
                <div class="flex flex-col items-center text-center max-w-[280px] relative">
                    <button onclick="event.stopPropagation(); window.dynamicIsland.closeOnboarding()" aria-label="Zamknij" class="absolute -right-4 -top-2 p-2 opacity-50 hover:opacity-100 transition-opacity">
